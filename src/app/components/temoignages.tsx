                ...
                <div className='flex items-center gap-2'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-6'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <p className='w-96 max-w-[95%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, sapiente mollitia. Accusantium impedit qui voluptatibus, iste magnam unde reprehenderit expedita iusto, perspiciatis, doloremque quidem asperiores eaque illo dignissimos tempora modi!</p>
